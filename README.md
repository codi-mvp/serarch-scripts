...
```
1. Полностью скопируйте скрипт **searchInJSON.js**, откройте *devTools* на пустой странице в браузере *about:blank* (это обязательно иначе ваш запрос не выполнится) вставьте скрипт в консоль и следуйте следующим шагам
